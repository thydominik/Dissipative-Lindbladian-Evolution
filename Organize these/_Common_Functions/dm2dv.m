function [RhoVec] = dm2dv(rho)
    ...
    % This part will order the density matrix into the density vector in
    % way that preserves the order of the mtx rows. I prefer this way,
    % because then we don't have to fiddle with the operators structure
%     Size = size(rho);
%     
% %     for i = 1:Size(1)
% %         for j = 1:Size(2)
